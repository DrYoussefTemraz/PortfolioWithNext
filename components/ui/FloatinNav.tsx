  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button className="border text-sm font-medium relative border-neutral-200 The class dark:border-white/20 can be written as `dark:border-white/20 text-black dark:text-white px-4 py-2 rounded-full">
          <span>Login</span>
