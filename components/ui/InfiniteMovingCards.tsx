  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-800 p-5 md:p-16 md:w-[60vw]"
            key={idx}
            style={{
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 text-sm md:text-base leading-[1.6] font-normal text-white dark:text-gray-100">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <div className="me-3">
                    <img src="/joe.jpg" alt="profile" width={40} height={40} className="rounded-full" />
                  </div>
